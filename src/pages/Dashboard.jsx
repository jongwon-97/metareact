...
function Dashboard() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // 회원 수 요약 데이터
        const userCountResponse = await axios.get("http://localhost:8091/api/admin/user/role/list", {
          headers: {
        ...
        // 회원 증감율 데이터
        const userGrowthResponse = await axios.get("http://localhost:8091/api/admin/user/list", {
          headers: {
            "Content-Type": "application/json",
          },
          withCredentials: true,
        ...
        // 강의 증감율 데이터
        const uploadResponse = await axios.get("http://localhost:8091/api/admin/course/monthlycount", {
          headers: {
            "Content-Type": "application/json",
          },
          withCredentials: true,
